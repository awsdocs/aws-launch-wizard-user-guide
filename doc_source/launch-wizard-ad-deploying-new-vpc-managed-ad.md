# Deploy AWS Directory Service for Microsoft Active Directory to a new Amazon Virtual Private Cloud<a name="launch-wizard-ad-deploying-new-vpc-managed-ad"></a>
