# Deploy AWS Directory Service for Microsoft Active Directory to an existing Amazon Virtual Private Cloud<a name="launch-wizard-ad-deploying-existing-vpc-managed-ad"></a>
